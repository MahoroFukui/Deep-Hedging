...
class Agent(torch.nn.Module, ABC):
    ...
    def pl(self, contingent_claim: Claim, P, T, logging = True, initial wealth=1.0): #calculates pl if criterion is not CRRA/is entropy; calculates terminal wealth if criterion is CRRA
        """
